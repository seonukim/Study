## BIT 2020.05.25 Review
___
##### 1. 데이터가 하나 주어졌을 때 predict, x, y로 나누기
- list slicing을 이용해 데이터를 잘라낸다
...
##### 2. train, test 8:2로 분할
- scikit-learn의 train_test_split() 함수를 이용

<train_test_split 예시코드>
...
<시각화 결과>
![matplotlib](https://github.com/seonukim/Study/blob/master/keras/loss.png)
