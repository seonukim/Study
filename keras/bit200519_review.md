...
# 3. 모델 구성
# 3-1. Input Layer 구성
input1 = Input(shape = (1, ))       # 입력 데이터가 (100, ) 이기 때문에
dense1 = Dense(50, activation = 'relu')(input1)
dense2 = Dense(45, activation = 'relu')(dense1)
dense3 = Dense(40)(dense2)
...
output1 = Dense(38)(dense3)
output2 = Dense(34)(output1)
output3 = Dense(3)(output2)     # 출력 데이터가 (100, 3) 이기 때문에
...
result = model.evaluate(x_test, y_test)
print("=" * 40)
print("Result : ", result)      # res : [0.8742836713790894, 0.8742836713790894]
...
# 6-1. RMSE 확인
print("=" * 40)
print("RMSE : ", RMSE(y_test, y_predict))       # res : 0.9350313527548797

# 6-2. R2 확인
print("=" * 40)
print("R2 : ", r2_score(y_test, y_predict))     # res : 0.99979027454957190.9987008965502687
```