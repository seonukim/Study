...
params = {
    ...
    'randomforestregressor__max_leaf_nodes': [10, 20, 30, 40, 50],
    'randomforestregressor__max_depth': [10, 20, 30, 40, 50],
    'randomforestregressor__n_estimators' : [100, 300, 500, 700]
}
...
print("Score : ", model.best_score_)                # Score :  0.9467731531925402
print("Best Parameters : ", model.best_params_)
'''
Best Parameters :  {'randomforestregressor__n_estimators': 500,
                    'randomforestregressor__max_leaf_nodes': 30,
