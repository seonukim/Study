...
def face_detector(path, w, h):
    ...
    for idex, folder in enumerate(folder_name):                   # 폴더별 이미지 불러오기
        ...
        for filename in f:                  # 파일 별로 이미지 불러오기
            ...
            detector = dlib.cnn_face_detection_model_v1('D:/Project/Project/weight/dogHeadDetector.dat')
...
np.save('D:/Project/Project/code/data/data/dog_image.npy', x)
np.save('D:/Project/Project/code/data/data/dog_label.npy', y)
print('------------- save complete ---------------')
