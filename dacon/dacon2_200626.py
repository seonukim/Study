...
X_data = np.loadtxt(path + '/comp3/train_features.csv', skiprows = 1, delimiter = ',')
X_data = X_data[:, 1:]
print(X_data.shape)
     
    
Y_data = np.loadtxt(path + '/comp3/train_target.csv', skiprows = 1, delimiter = ',')
Y_data = Y_data[:, 1:]
print(Y_data.shape)
...
X_data_test = np.loadtxt(path + '/comp3/test_features.csv', skiprows = 1, delimiter = ',')
...
submit = pd.read_csv(path + '/comp3/sample_submission.csv')
...
submit.to_csv(path + '/comp3/submission_200626.csv', index = False)